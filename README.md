...
### 🔒 Fase restrittiva (da `getScenariosConfig()`)

| Scenario (GUI) | Distanze (m) | Tempi (h/gg) | DoseConstraint (mSv) |
|---|---:|---:|---:|
| **Partner** | 1.0 | 2.0 | 3.0 |
| **Trasporto pubblico** | — | — | 0.3 |
| **Bambino <2 aa** | 1.0, 2.0 | 1.5, 2.0 | 1.0 |
| **Bambino 2–5 aa** | 1.0, 2.0 | 1.5, 1.5 | 1.0 |
| **Bambino 5–11 aa** | 1.0 | 2.5 | 1.0 |
| **Donna incinta** | 1.0 | 2.0 | 1.0 |
| **Colleghi lavoro** | — | — | 0.3 |

Note operative:
- per **Trasporto** e **Colleghi** la fase restrittiva è modellata come *assenza/evitamento* (nessun contatto nello scenario restrittivo); la regola specifica per il **Trasporto** è espressa in **ore** e viene mostrata come output informativo.
- le durate ottimali $T_{\text{res}}$ sono calcolate da `DoseCalculator` imponendo i vincoli sopra riportati.


### 👥 Fase ordinaria (post-restrizione, da `getScenariosConfig()`)

Dopo $T_{\text{res}}$ il paziente rientra in una routine più “ordinaria”.
Gli scenari ordinari riflettono contatti più lunghi ma, in media, a distanze maggiori.

> Convenzione: la distanza **999 m** indica “lontano/trascurabile”.

| Scenario (GUI) | Distanze (m) | Tempi (h/gg) | Note |
|---|---:|---:|---|
| **Partner (ord.)** | 0.5, 1.0, 2.0 | 6.0, 3.5, 2.0 | routine domestica |
| **Trasporto (ord.)** | 0.3, 1.0, 999 | 1.0, 2.0, 20.5 | promemoria comportamentale |
| **Bambino <2 (ord.)** | 0.1, 0.5, 1.0, 999 | 1.0, 2.0, 2.0, 12.0 | include contatti ravvicinati |
| **Bambino 2–5 (ord.)** | 0.5, 1.0, 2.0, 999 | 2.0, 1.0, 2.0, 16.0 | — |
| **Bambino 5–11 (ord.)** | 1.0, 2.0, 999 | 3.0, 2.0, 12.0 | — |
| **Donna incinta (ord.)** | 1.0, 999 | 6.0, 18.0 | — |
| **Colleghi (ord.) – Standard** | 1.0, 999 | 7.3, 14.5 | (8,16)×0.9093 |
| **Colleghi (ord.) – Sempre ≥2 m** | 2.0, 999 | 8.0, 16.0 | opzione GUI |

Nota: i contatti oltre i 2 m sono tipicamente considerati trascurabili ai fini della dose.
